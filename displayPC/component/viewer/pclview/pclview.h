...
#include "process/perception/bounding_box.h"
...
public:
  ...
  void inputObjCloud(pcl::PointCloud<pcl::PointXYZI> obsCloudIn = pcl::PointCloud<pcl::PointXYZI>());
  void inputOriCloud(pcl::PointCloud<pcl::PointXYZI> oriCloudIn = pcl::PointCloud<pcl::PointXYZI>());
  void inputObj(std::vector<ObjectBox> obsIn = std::vector<ObjectBox>());
  void displayCloud();
